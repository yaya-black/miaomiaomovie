...
<div id="main">
    ...
    <Header title="喵喵电影"/>
       <div id="content">
           <!-- 二级导航部分  其中router-link用来做按钮跳转的 -->
			<div class="movie_menu">
				<router-link tag="div" to="/Movie/City"  class="city_name">
					<span>{{$store.state.city.nm}}</span><i class="iconfont icon-lower-triangle"></i>
				</router-link>
				<div class="hot_swtich">
					<router-link tag="div" to="/Movie/MoviePlaying" class="hot_item">正在热映</router-link>
...
import TabBar from '@/components/TabBar';  //引入Header和TabBar
...
.movie_menu .search_entry{ margin-right:20px; height:100%; line-height: 45px;color:#666;}
